...
\begin{itemize}
	\itemBold{FR**} The system must offer the possibility to logout to a given RP.
	\itemBold{FR**} After the logout, the system must redirect the RP to the \myTaxiService{} home page.
