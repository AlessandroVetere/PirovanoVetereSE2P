...
\begin{itemize}
	...
	\itemBold{FR7} The system rejects a taxi driver personal data.
	\itemBold{FR8} The system rejects a registered passenger personal data.
\end{itemize}
\paragraph{Scenarios}
\begin{itemize}
	...
	He fill all the required fields with his data, accepts the data management and privacy contract and then a dialog confirms his registration to the service.
	An email also arrives at his address.
	Being now a registered user, he can start using \myTaxiService{} in town.
	\item Alice is a taxi driver and she got his login credentials on the day she was hired, so she don't need to register to \myTaxiService{} at all.
\end{itemize}
