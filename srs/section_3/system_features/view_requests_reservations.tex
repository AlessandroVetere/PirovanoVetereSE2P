...
\begin{itemize}
	\itemBold{FR**} The system must be capable of loading a given RP data at any time.
	\itemBold{FR**} The system must ask a RP for cancel confirmation before actually cancelling a taxi ride.
	\itemBold{FR**} A message must be displayed in place of an empty list in case there's not Taxi Request to display or in case the Taxi Reservations list is empty for a given RP.
