...
\begin{itemize}
	\itemBold{FR**} The system must check the correctness of the RP's inserted data.
	\itemBold{FR**} The system must correctly handle internally the added taxi reservation.
	\itemBold{FR**} The system must notify the RP about the result of his operation.
