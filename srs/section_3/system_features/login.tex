...
\begin{itemize}
	\itemBold{FR**} The system must check the correctness of the user's inserted data.
	\itemBold{FR**} The system must correctly handle internally the login token assignment to the user.
	\itemBold{FR**} The system must notify the user about the result of his login.
