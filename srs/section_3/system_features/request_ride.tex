...
\begin{itemize}
	...
	\itemBold{Post condition} Sarah is still logged to \myTaxiService{}, she has received a Notification Message and she is now waiting for the a system message with a Taxi ID and a waiting time.
	\itemBold{Event Flow}
	\begin{itemize}
