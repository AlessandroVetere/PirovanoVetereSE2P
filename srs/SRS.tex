...
\newcommand{\showGeneralDiagram}{\showPercentImage{\sectionBaseDir{2}/general_diagram.png}{General Diagram}{0.95}}
...
\newcommand{\showTDMockupImage}[2]{\showPercentImage{\sectionBaseDir{3}/mockups/png_driver/#1.png}{#2}{0.275}}
%
