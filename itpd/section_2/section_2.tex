...
\begin{center}
	\begin{tikzpicture}[node distance=2cm, auto]
		...
		\node [block, below of=taxi_driver_manager, fill=green!20] (queue_manager) {Queue Manager};
		...
		\path [line] (taxi_driver_manager) -| (dispatcher);
		\path [line] (queue_manager) -- (dispatcher);
