...
Referring to the diagram semantic explanation given in section 2.4, the reader can understand the meaning of each diagram.
Further details about each testing step (represented as arrows), are then given in the following section.
