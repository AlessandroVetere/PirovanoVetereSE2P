...
\subsection{Model Integration Sequence}
\begin{center}
	\begin{tikzpicture}[node distance=2cm, auto]
		% Place nodes
		\node [block, fill=yellow!520] (datbase_driver_adapter) {Database Driver Adapter};
...
\subsection{Controller Business Components Integration Sequence}
\begin{center}
	\begin{tikzpicture}[node distance=2cm, auto]
		% Place nodes
...
\subsection{Controller Networking Components Integration Sequence}
\begin{center}
	\begin{tikzpicture}[node distance=2cm, auto]
		% Place nodes
		\node [block, fill=brown!20] (dispatcher) {Dispatcher};
...
\subsection{Passenger View Integration Sequence}
\begin{center}
	\begin{tikzpicture}[node distance=2cm, auto]
		% Place nodes
		...
		\node [block, right of=psr, fill=green!20, node distance=2.5cm, fill=brown!20] (dp) {Dispatcher};
		% Draw edges
...
\subsection{Taxi Driver View Integration Sequence}
\begin{center}
	\begin{tikzpicture}[node distance=4.5cm, auto]
		...
		\node [block, below of=tr, fill=green!20, node distance=2cm, fill=brown!20] (dispatcher) {Dispatcher};
		% Draw edges
		\path [line] (rs) -- (treq);
		\path [line] (treq) -- (tapp);
		\path [line] (tapp) -- (tr);
...
\subsection{Administrator View Integration Sequence}
\begin{center}
	\begin{tikzpicture}[node distance=2cm, auto]
		% Place nodes	
