...
\reqTracTab{
		...
		The formal constraints are handled by the \textbf{Taxi Ride Manager}: this component has the responsability of checking the request details validity. If the request doesn't respect the constraints, than the \textbf{Taxi Ride Manger} has to inform the related \textbf{Passenger} of the failure.
		\\
		\hline
		FR27 &
