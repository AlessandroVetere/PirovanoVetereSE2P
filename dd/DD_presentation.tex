...
\begin{document}
	...
	\begin{frame}{Administrator Mockups}
		...
		Consequently the administrator can perform his actions both using a different channel from the normal application access, and using a intuitive an lightweight UI.
