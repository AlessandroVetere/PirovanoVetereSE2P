...
\begin{document}
	...
	\begin{frame}{Component View - Diagram}
		This diagram maps system \textbf{features into different software components}, and show \textbf{how these components interact} in order to \textbf{guarantee the software functionalities}.
