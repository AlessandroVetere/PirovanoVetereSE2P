...
\begin{document}
	...
	\begin{frame}{Component View - Diagram}
		...
		\showComponentDiagram{UML Component Diagram}{0.45}
	\end{frame}
	...
	\begin{frame} {Taxi Driver Mockups - Overview}
		...
		\begin{itemize}
			...
			\item If it is not solvable, the system assigns the incomplete ride to the next \textbf{Taxi Driver} in the \textbf{Zone Queue}.
		\end{itemize}
	\end{frame}
