...
\begin{document}
	...
	\begin{frame}{Component View}
		...
		\begin{itemize}
			\item Passenger View, Taxi Driver View, Taxi Driver Model and Administrator View
			\item Controller
			\item Model
		\end{itemize}
	\end{frame}
	...
	\begin{frame}{Component View - Diagram}
		This diagram maps system features into different software components, and show how these components interact in order to guarantee the software functionalities.
