...
\begin{itemize}
	...
	\unbreakableItem{Register New Taxi Driver
		\showAdminMockupImage{admin_mockup_2}{State 1 of Administrator personal page.}}
	\unbreakableItem{Search Taxi Driver
		\showAdminMockupImage{admin_mockup_3}{State 2 of Administrator personal page.}}
	\unbreakableItem{Change License Plate Number
		\showAdminMockupImage{admin_mockup_4}{State 3 of Administrator personal page.}}
	\unbreakableItem{Delete Taxi Driver
		\showAdminMockupImage{admin_mockup_5}{State 4 of Administrator personal page.}}
\end{itemize}