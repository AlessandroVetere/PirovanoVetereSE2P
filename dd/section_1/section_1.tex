...
\begin{itemize}
	...
	\itemBold{Algorithm Design} Here are exposed some of the algorithms that have been designed in order for the application to work in the desired way. Some Java code is used to show in a more coherent, correct and meaningful way such algorithms.
	...
	\end{itemize}
	\itemBold{Requirements Traceability} In this part of the document are traced the requirements that were discovered in the RASD to design and architectural decisions.
\end{itemize}