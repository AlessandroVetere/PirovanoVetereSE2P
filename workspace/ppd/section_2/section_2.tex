...
\begin{itemize}
	...
	\begin{itemize}
		...
		\itemBold{Architecture/Risk Resolution} Since we had designed several documents before the actual development, including this \textit{PPD}, the development of the system to be has little chances of failing, so we choose a \textbf{Nominal} value.
