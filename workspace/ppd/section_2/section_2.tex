...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\itemBold{Analyst Capability} The personnel demostrates a \textbf{Nominal} level of analysis ability.
			\itemBold{Programmer Capability} The personnel demostrated efficiency working together as a team, so we chose \textbf{High} level for this parameter.
			\itemBold{Personnel Continuity} The project will be developed always by the initial programmers, so the \textit{project's annual personnel turnover} is very low ( a 7 \% for year ). For this reason we have chosen \textbf{High} for this parameter.
			...
			\itemBold{Platform Experience} The same as \textit{Application Experience}. We have chosen \textbf{Nominal} level for this parameter.
			\itemBold{Language and Toolset Experience} The team is quite familiar with the development, analysis and design representation, so we chose \textbf{High} level for this parameter.
		\end{itemize}
		\item \textbf{Platform}
		\begin{itemize}
		...
		\item \textbf{Project}
		\begin{itemize}
			\itemBold{Use of Software Tools} The team is provided of a set of strong, mature life-cycle tools, moderately integrated each other. So we chose an \textbf{High} level for this parameter.
			\itemBold{Multisite Development} The team in average is fully collocated, so the chosen level is \textbf{Nominal}.
	...
	\begin{itemize}
		\itemBold{Cost per Person-Month (Dollars)} We have chosen an average value for this parameter: \textbf{1500\$/month}.
	\end{itemize}	
\end{itemize}
Using the previous parameters, we have compiled the \textbf{COCOMO II - Model}:
\showPercentImage{\sectionBaseDir{2}/cocomo1.png}{ciao}{1}
And these are the results:\\
\showPercentImage{\sectionBaseDir{2}/cocomo2.png}{ciao}{1}
%