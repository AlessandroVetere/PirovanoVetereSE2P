...
\begin{center}
	...
	\begin{ganttchart}[hgrid=true, x unit=2.5mm, link bulge=0.9]{1}{44}
		...
		\gantttitle{2015}{8} \gantttitle{2016}{36} \\
			  \ganttbar{T1a}{1}{2} \\
		\ganttlinkedbar{T1b}{3}{2} \\
		\ganttlinkedbar{T2a}{3}{5} \\
		\ganttlinkedbar{T2b}{6}{5} \\
		\ganttlinkedbar{T3a}{9}{9} \\
		\ganttlinkedbar{T3b}{10}{9} \\
		\ganttlinkedbar{T4a}{10}{11} \\
		\ganttlinkedbar{T4b}{12}{11} \\
		\ganttlinkedbar{T5}{12}{24} \\
		\ganttlinkedbar{T6}{25}{28} \\
		\ganttlinkedbar{T7}{29}{32} \\
		\ganttlinkedbar{T8}{33}{36} \\
		\ganttlinkedbar{T9}{37}{40} \\
		\ganttlinkedbar{T10}{41}{44} \\
		\ganttlinkedbar{T11}{45}{44}
	\end{ganttchart}
\end{center}
%