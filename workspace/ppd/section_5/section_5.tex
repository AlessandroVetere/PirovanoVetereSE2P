...
\begin{itemize}
	...
	\begin{itemize}
		...
		\itemBold{Sales Risk}
		\begin{enumerate}
			\risk{The project, once developed, comes out as too complex and not easily marketable.}{MEDIUM}{}{}
			\risk{The user interfaces developed are not user-friendly.}{LOW}{}{}
			\risk{The project, once developed, demonstrates a complete misunderstanding of the requirements.}{LOW}{}{}
		\end{enumerate}
		...
		\begin{enumerate}
			\risk{The company changes the management group and the new one decides to change the project focus or the project work force.}{LOW}{}{}
		\end{enumerate}
		...
		\begin{enumerate}
			\risk{The company decides to assign less money than promised for the development of \myTaxiService{}.}{LOW}{}{}
			\risk{One or both the developers of \myTaxiService{} decide to stop the development for an overlapping with other personal commitments.}{LOW}{}{}
		\end{enumerate}
	\end{itemize}
\end{itemize}
%
