...
\begin{itemize}
	\itemBold{FR18} The system must check the correctness of a RP's inserted data.
	\itemBold{FR19} The system must be coherent with the RP inserted data modification, if the modification goes fine.
	\itemBold{FR20} The system must inform a RP about the result of his modification.
	\itemBold{FR21} The system must peacefully handle a connection error and notify the user of the problem.
\end{itemize}
\paragraph{Scenarios}
\begin{itemize}
