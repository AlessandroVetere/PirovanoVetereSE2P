...
\begin{document}
	...
	\begin{frame}{UML Use Case Diagram}
		...
		\showPercentImageNoCaption{../rasd/section_3/uml/UseCaseDiagram.png}{0.65}
	\end{frame}
	\begin{frame}{UML Class Diagram}
		...
		\showPercentImageNoCaption{../rasd/section_3/uml/ClassDiagram.png}{0.675}
	\end{frame}
	\subsection{Alloy}
	\begin{frame}{Alloy}
	...
	\begin{frame}{Taxi Driver Registration}
		\showSequenceDiagram{admin_td_reg}{0.7}
	\end{frame}
