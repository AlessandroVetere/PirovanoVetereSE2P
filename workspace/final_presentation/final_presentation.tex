...
\begin{document}
	...
	\begin{frame}{Integration Testing Strategy}
		...
		\medskip
		\begin{itemize}
			\itemBold{Model} In order to test its relevant functionalities, the tester has to simulate the behavior of the \textbf{Controller} with a dedicated \textbf{Driver}. \\
